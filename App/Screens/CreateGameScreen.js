...
export default function CreateGame(props) {
  ...
  return (
    <Container style={createGameStyles.container}>
      <View style={createGameStyles.firstBox}>
        <Text style={createGameStyles.text}>Create a new Game</Text>
      </View>
      <View style={createGameStyles.inputFields}>
        <InputField
      ...
      <View style={createGameStyles.buttons}>
        <Button
          onPress={() => props.navigation.navigate('GameRoom')}
          label="Create"
        />
      </View>
      <Footer />
...
//// style-components ////
const createGameStyles = StyleSheet.create({
  container: {
    flex: 1,
    display: 'flex',
    alignItems: 'center',
